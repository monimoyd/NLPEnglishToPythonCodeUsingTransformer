...
from utils.translate_attention_utils import translate_sentence


def calculate_meteor_score(data, src_field, trg_field, trg_type_field, model, device, max_len = 250):
    ...
    return meteor_score(pred_trgs, trgs )
